...
class QuantitativeMLForecaster:
    ...
    def prepare_ml_features(self, window=30):
        """Compatibility wrapper: return engineered features for ML workflows."""
        return self.engineer_quantitative_features(window=window)
    ...
    def forecast_future(self, periods=13 * 30):
        ...
        for i in range(periods):
            ...
            # Update lag features based on ensemble prediction
        ...
        self.forecast_df['lower_bound'] = \
            self.forecast_df['ensemble'] - self.forecast_df[['linear', 'rf', 'xgb']].std(axis=1) * 1.96
